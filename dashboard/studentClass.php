...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <!-- start for get next session -->

        <!-- end for get next session -->
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <h5 class="card-title"> Students List of class <?php echo $currentClassName; ?></h5>
                            </div>
                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                            ...
                            <table class="table table-hover" id="studentList">
                                ...
                                <tbody>
                                    <?php
                                    $sql5 = "SELECT class.id, class.class_name, admission.* from admission left JOIN class on class.id = admission.class_id WHERE admission.school_id = '$school_id' and class.id='$currentClass' and admission.session='$session' order by admission.id desc";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                $sql50 = "select * from section WHERE id = '$current_Section_id'";

                                                $res50 = mysqli_query($conn, $sql50);
                                                $countSection = mysqli_num_rows($res50);
                                                if ($countSection == 1) {
                                                    while ($data50 = mysqli_fetch_assoc($res50)) {
                                                       echo $section = $data50["section"];
                                                    }
                                                } else {
                                                   echo $section = 0;
                                                }
