...
INNER JOIN class ON admission.class_id=class.id where class.id='$class' and admission.school_id = '$school_id' and admission.session = '$session' and receipt.date='$date'";
