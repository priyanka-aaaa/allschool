...
$receiptId = $_GET["id"];
$sql2 = "SELECT receipt.session,receipt.remark, receipt.date,receipt.datetime,receipt.convenience_charge_amount,receipt.exam_fee_amount,receipt.convenience_fee_month ,receipt.fee_month,receipt.total_paying_amount,receipt.checkNumber,receipt.checkDate,receipt.balance_amount,class.class_name,
 admission.roll_no,admission.name,admission.father_name,admission.section_id,receipt.offline_payment_amount,receipt.online_payment_amount FROM ((receipt
                           ...
                           <div class="receipt-date">
                              <form>
                                 <div class="inforow">
                                    ...
                                    <div class="block">
                                       <p class="border-bottom"><strong>Roll No</strong><span><?php echo $roll_no; ?></span></p>
                                    </div>
                                 </div>
                                 <div class="inforow">
                                    <div class="col2block">
                           ...
                           <table align="center" cellpadding="0" cellspacing="0" width="100%" border="0" style="background:#fff;margin-top:30px;border:2px solid #e6e6e6;padding:10px 20px">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <p style="font-size:14px;margin-top:35px;line-height:24px;color:#474747; padding-left:10px;"><strong>Fee For: </strong> <?php echo $fee_month; ?> </p>
