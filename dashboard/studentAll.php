...
while ($row = mysqli_fetch_assoc($res5)) {
    $data[] = array(
        ...
        "action" =>
        '<a target="_blank" href="studentView.php?studentId=' . $row["id"] . '"><i class="fa fa-eye"></i></a>
        
        <a target="_blank" href="studentEdit.php?studentId=' . $row["id"] . '"><i class="fa fa-edit"></i></a>
      
      
        <a class="studentDelete" attr-value="' . $row["id"] .'"><i class="fa fa-trash" aria-hidden="true"></i></a>
        <a target="_blank" href="studentReceiptAll.php?studentId=' . $row["id"] . '">  <i class="fas fa-receipt"></i></a>
      '
