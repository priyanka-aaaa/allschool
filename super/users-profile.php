      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            <?php
            $adminid = $_SESSION['id'];
            $query3 = "SELECT * FROM school_details WHERE admin_id='$adminid'";
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8">ST. Peter Convent School</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Email</div>
                  <div class="col-lg-9 col-md-8">saintpeterconventschool@gmail.com</div>
                </div>
